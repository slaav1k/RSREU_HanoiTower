...
def main():
    print("""
    ============================================================
              ХАНОЙСКАЯ БАШНЯ - Интерактивный решатель
    ============================================================
    Разработчик: Архипкин Вячеслав

    Добро пожаловать! Эта программа решает классическую задачу
    «Ханойская башня» универсальным методом.

    Введите параметры - и я найду решение!
    ============================================================
    """)
    try:
